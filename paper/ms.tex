...
several kinds of signals have been suggested that may be viable. Here I list a few general classes of technosignature signals that may be well suited for developing detection algorithms around:

\begin{itemize}
\item unusual variability -- either on short timescales (e.g. Boyajian's Star) or long timescales (e.g. VASCO)
...
\item unnatural patterns, particularly of otherwise normal variability -- e.g. a prime or fibonacci sequence
\end{itemize}
