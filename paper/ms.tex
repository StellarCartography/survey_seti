...
In this paper I explore the potential of wide-field time domain surveys for conducting a new generation of technosignature searches. 
In \S\ref{sec:method} I describe the general principle behind technosignature searches in time domain surveys, including spatial over-densities of light curve signals and coordinated signals between multiple sources, for example.
...
\label{sec:method}
METHOD: what is the big idea, in detail

include mantras of "worth doing", "do it almost for free", "portable, do it everywhere", and "outliers are nature papers"
