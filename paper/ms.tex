...
In this paper I provide an overview of the potential for new SETI studies based on time domain surveys. %In \S\ref{sec:surveys} I describe several relevant surveys that are promising data sources for deploying automated SETI algorithms.
