...
Rather than searching for an exoplanet beacon of outliers of systems in spatial density or distribution, we can consider clusters of systems that are unusually similar in some way. In the simplest case this could take the form of a cluster of transiting exoplanets with the same radius, transit depth, transit ephemeris (or transit midpoint), or orbital period, for example. Here I demonstrate a simple algorithm for searching for clusters of exoplanets with unusually similar orbital periods.
