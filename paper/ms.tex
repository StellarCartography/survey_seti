...
\caption{
comparison of the 8D ``Cosmic Haystack'' volume fraction defined by \citet{wright2018c} using five optical surveys with varying designs. 
}
\label{fig:hay}
\end{figure}
...
%, as well as Gaia \citep{gaia} provide incredible precision light curves for millions of stars.
