...
trivial example: two point correlation of exoplanets, not substantively different from field stars, so not a total engineering of the Kepler field. OK
...
%%%%%% 
%    > shelve this idea for now, maybe another paper.... 1 demo is enough for this paper, 
%    and it should be actually computed/worked out.
%%%%%% 
